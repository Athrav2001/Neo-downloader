package com.neo.downloader.android.pages.directorypicker
...
import ir.neo.util.createDirectories
import ir.neo.util.exists
import ir.neo.util.isDirectory
import ir.neo.util.listFiles
import ir.neo.util.listFilesOrNull
import ir.neo.util.startsWith
...
fun DirectoryPicker(
    ...
    ResponsiveDialog(
        ...
        val storagePermissionState = rememberAppPermissionState(NDMPermissions.StoragePermission)
